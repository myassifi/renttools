        ...
        {panelOpen ? (
          ...
          <div className="flex h-full min-h-[320px] flex-col gap-5 px-6 py-8">
            {/* Property switcher — fallback to the top-bar dropdown
                so the user can move between properties (or jump to
                the all-properties row view) without leaving the
                calendar. Hidden when only one property exists
                (PropertySwitcher early-returns). */}
            {properties.length > 1 && (
              <PropertySwitcher
