...
export type AuditResource =
  ...
  | "expense" // finance module: expense create/update/delete
  | "accessCode" // smart-lock door codes: generate / revoke
  | "lockCredential"; // smart-lock provider account connect / disconnect
